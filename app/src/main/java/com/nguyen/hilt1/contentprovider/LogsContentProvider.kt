package com.nguyen.hilt1.contentprovider
...
class LogsContentProvider: ContentProvider() {
    ...
    @EntryPoint
    // An entry point is an interface with an accessor method for each binding type we want. the
    // interface must be annotated with @InstallIn to specify the component in which to install the
    // entry point.
